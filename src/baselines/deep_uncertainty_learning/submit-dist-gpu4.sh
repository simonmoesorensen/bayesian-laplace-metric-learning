...
#BSUB -oo logs_dist/DUL-face-recognition-gpu4-run1.out
#BSUB -eo logs_dist/DUL-face-recognition-gpu4-run1.err
# -- end of LSF options --
...
model_save_folder='./checkpoints/exp_dul_dist/gpu4/'
log_tensorboard='./logtensorboard/exp_dul_dist/gpu4/'
