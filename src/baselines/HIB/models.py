...
from src.baselines.models import CIFAR10ConvNet, FashionMNISTConvNet, CUB200ConvNet, FashionMNISTLinearNet, CIFAR10LinearNet
...
def MNIST_HIB(embedding_size=128, linear=False):
    """
...
def CIFAR10_HIB(embedding_size=128, linear=False):
    """
...
def Casia_HIB(embedding_size=128, linear=False):
    """
...
def Cub200_HIB(embedding_size=128, linear=False):
